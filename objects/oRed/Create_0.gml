...
/*
	전술적 목표
*/
attack_enemy = oBlue									// 공격의 목표가 되는 객체의 종류
attack_target = noone									// 공격의 목표 개체
support_ally = oRed										// 지원의 목표가 되는 객체의 종류
support_target = noone								// 지원을 받을 개체
cover_object = oBlock									// 숨을 객체의 종류
cover_target = noone									// 숨을 개체
dodge_object = oBlueBullet						// 피할 객체의 종류
dodge_target = noone									// 피해야 할 개체

/*
	공격 속성
*/
attack_projectile = oRedBullet				// 공격 수단
